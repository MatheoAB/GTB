...
if (!isset($_SESSION["Nom"]) || !isset($_SESSION["user_role"]) || $_SESSION["user_role"] !== "Administrateur") {
    // Redirigez vers la page de connexion ou une page d'accès refusé
...
<div class="header" style="background-color:#665264">
  <a href="index2.php"><img src="./smica.png" width="400"></a>
</div>
...
<div class="topnav">
  ...
  <a href="compte.php" style="float:right"><i class="fa-solid fa-user"></i> <?php echo htmlspecialchars($Nom); ?></a>
</div>
<br>
<div id="chart"></div>
